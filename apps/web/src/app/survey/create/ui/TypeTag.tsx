      ...
      variants: {
        type: {
          EITHER_OR: `bg-amber-50 text-amber-600 ${
            selected &&
            "bg-amber-100 text-amber-700 ring-1 ring-amber-400 hover:ring-amber-300"
          }`,
          SCALE: `bg-green-50 text-green-700 ${
            selected &&
            "bg-green-100 text-green-800 ring-1 ring-green-400 hover:ring-green-300"
          }`,
          MULTIPLE_CHOICE: `bg-sky-50 text-sky-600 ${
            selected &&
            "bg-sky-100 text-sky-700 ring-1 ring-sky-400 hover:ring-sky-300"
          }`,
          SUBJECTIVE: `bg-rose-50 text-rose-600 ${
            selected &&
            "bg-rose-100 text-rose-700 ring-1 ring-rose-400 hover:ring-rose-300"
          }`,
        },
      },
    }
