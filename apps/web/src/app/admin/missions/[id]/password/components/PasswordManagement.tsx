...
export function PasswordManagement({ missionId }: PasswordManagementProps) {
  ...
  if (!mission) {
    return (
      <div className="p-8 border border-dashed rounded-lg text-center text-muted-foreground">
        {UBQUITOUS_CONSTANTS.MISSION} 정보를 불러올 수 없습니다.
      </div>
    );
  }
                ...
                {hasPassword ? (
                  <>
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        이 {UBQUITOUS_CONSTANTS.MISSION}은 비밀번호로 보호되고 있습니다
                      </div>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        누구나 이 {UBQUITOUS_CONSTANTS.MISSION}에 접근할 수 있습니다
                      </div>
                    </div>
                  </>
                )}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {UBQUITOUS_CONSTANTS.MISSION}에 접근할 수 있게 됩니다.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
