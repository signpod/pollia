import { multipleChoiceMaxSelectionsAtom } from "@/atoms/action/creation/multipleChoice";
import { SurveyQuestionOption } from "@/components/mission/ActionOption";
import { useMultipleChoiceOptions } from "@/hooks/action";
