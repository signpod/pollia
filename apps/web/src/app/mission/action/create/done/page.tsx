...
function ActionCreateDoneContent() {
    ...
    <div className="pt-60">
      ...
      <FixedBottomLayout.Content className="flex w-full justify-center bg-white">
        ...
        >
          ...
          <Link href={ROUTES.MISSION_CREATE} className="w-full">
            <Button className="w-full" variant="primary" aria-label="설문지 만들기">
              <Typo.ButtonText size="large">설문지 만들기</Typo.ButtonText>
            </Button>
          </Link>
        </motion.div>
