...
import { DrawerProvider, DrawerContent, IconButton,  Typo, useDrawer, KakaoLoginButton } from "@repo/ui/components";
    ...
    <DrawerContent className="max-w-[600px]">
      <div className="relative px-5 pb-5 pt-5">
        ...
        <div className="flex flex-col items-center gap-6 pt-4 pb-2">
          ...
          <KakaoLoginButton inlineIcon onClick={handleKakaoLogin} className="w-full bg-[#FEE500] text-default hover:bg-[#FEE500]/90" />
        </div>
      </div>
    </DrawerContent>
  );
