import { SurveyQuestionOptionButton } from "@/app/survey/[id]/components/SurveyQuestionOptionButton";
import type { Meta, StoryObj } from "@storybook/nextjs";

const meta: Meta<typeof SurveyQuestionOptionButton> = {
  title: "Survey/SurveyQuestionOptionButton",
...
export const Default: Story = {
  render: args => (
    <div className="w-full max-w-[390px]">
      <SurveyQuestionOptionButton {...args} />
    </div>
  ),
  args: {
    title: "선택지 제목",
  ...
  render: () => (
    <div className="w-full max-w-[390px] space-y-6">
      <div>
        ...
        <SurveyQuestionOptionButton title="카페에서 커피 마시기" />
      </div>
    ...
    <div className="w-full max-w-[390px] space-y-6">
      <div>
        ...
        <div className="flex flex-col gap-3">
          <SurveyQuestionOptionButton title="네" />
          <SurveyQuestionOptionButton title="아니오" />
          <SurveyQuestionOptionButton title="잘 모르겠습니다" />
        </div>
      </div>
