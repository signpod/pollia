...
const sampleData: MissionFunnelData = {
  nodes: [
    ...
    { id: "1. 질문 1 완료", name: "1. 질문 1 완료", type: "response", count: 80 },
  ...
  links: [
    ...
    { source: "1. 질문 1", target: "1. 질문 1 완료", value: 80 },
    { source: "1. 질문 1", target: "1. 질문 1 이탈", value: 10 },
    { source: "1. 질문 1 완료", target: "2. 질문 2", value: 80 },
  ...
  args: {
    data: {
      nodes: [
        ...
        { id: "1. 질문 1 이탈", name: "이탈", type: "drop", count: 0 },
        { id: "1. 질문 1 완료", name: "1. 질문 1 완료", type: "response", count: 500 },
      ...
      links: [
        ...
        { source: "1. 질문 1", target: "1. 질문 1 완료", value: 500 },
        { source: "1. 질문 1", target: "1. 질문 1 이탈", value: 300 },
        { source: "1. 질문 1 완료", target: "2. 질문 2", value: 500 },
  ...
  args: {
    data: {
      nodes: [
        ...
        { id: "1. 질문 1 완료", name: "1. 질문 1 완료", type: "response", count: 100 },
      ...
      links: [
        ...
        { source: "1. 질문 1", target: "1. 질문 1 완료", value: 100 },
        { source: "1. 질문 1 완료", target: "2. 질문 2", value: 100 },
