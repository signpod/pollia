import { Branch } from "@/components/common/templates/action";
        ...
        options: [
          {
            id: "opt-1",
            title: "초보자",
            description: "처음 시작하는 분들을 위한 가이드",
            imageUrl: null,
            order: 0,
            actionId: "action-1",
            fileUploadId: null,
            createdAt: new Date(),
            updatedAt: new Date(),
            nextActionId: "action-beginner",
            nextCompletionId: null,
          },
          {
            id: "opt-2",
            title: "전문가",
            description: "깊이 있는 내용을 원하는 분들을 위한 과정",
            imageUrl: null,
            order: 1,
            actionId: "action-1",
            fileUploadId: null,
        ...
        options: [
          {
            ...
            createdAt: new Date(),
            updatedAt: new Date(),
            nextActionId: "action-continue",
            nextCompletionId: null,
          },
          {
            id: "opt-2",
            title: "아니오, 여기서 마치겠습니다",
            description: "완료 페이지로 이동합니다",
            imageUrl: null,
            order: 1,
            actionId: "action-1",
            fileUploadId: null,
            ...
            updatedAt: new Date(),
            nextActionId: null,
            nextCompletionId: "completion-early-exit",
          },
        ],
      })}
    />
