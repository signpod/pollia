...
export const WithoutHeader: Story = {
  render: () => (
    <DrawerProvider>
      ...
      <DrawerContent>
        <div className="p-5">
          <h3 className="text-lg font-semibold mb-3">커스텀 헤더</h3>
          <p className="text-gray-600 mb-4">
  ...
  render: () => (
    <DrawerProvider>
      ...
      <DrawerContent>
        ...
        <div className="p-5 pb-8">
          <p className="text-gray-600 mb-4">
            헤더에 닫기 버튼이 없습니다. ESC 키나 오버레이 클릭으로만 닫을 수
            있습니다.
          </p>
      ...
      <DrawerContent>
        ...
        <div className="p-5 pb-8 overflow-y-auto">
          ...
          {Array.from({ length: 20 }, (_, i) => (
            <div key={i} className="p-4 mb-3 bg-gray-50 rounded-lg">
      ...
      <DrawerContent>
        ...
        <div className="p-5 pb-8">
          <p className="text-gray-600">
            이 Drawer는 기본적으로 열린 상태로 렌더링됩니다. DrawerProvider의
            defaultOpen prop을 true로 설정했습니다.
          </p>
        </div>
      </DrawerContent>
    </DrawerProvider>
...
export const CustomStyle: Story = {
  render: () => (
    <DrawerProvider>
      ...
      <DrawerContent className="bg-gradient-to-b from-blue-50 to-white border-t-4 border-blue-500">
        <DrawerHeader className="bg-blue-100/50">커스텀 스타일</DrawerHeader>
        <div className="p-5 pb-8">
          <div className="bg-blue-50 p-4 rounded-lg mb-4">
            <h4 className="font-medium text-blue-900 mb-2">알림</h4>
            <p className="text-blue-700 text-sm">
              이 Drawer는 커스텀 스타일이 적용되었습니다. 파란색 테마로 꾸며져
              있습니다.
            </p>
          </div>
          <Button
