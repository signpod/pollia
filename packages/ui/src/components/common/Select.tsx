...
/**
 * Select Component with Full Accessibility Support
 *
 * 웹 접근성 기능:
 * - ARIA 속성 자동 적용 (aria-label, aria-expanded, aria-selected)
 * - 키보드 네비게이션 (Enter, Space, ArrowUp, ArrowDown, Escape, Home, End)
 * - 포커스 관리 및 트랩
 * - 스크린 리더 완벽 지원
 *
 * @example
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-sm font-semibold text-[var(--color-zinc-700)]",
      className
    )}
    {...props}
  />
